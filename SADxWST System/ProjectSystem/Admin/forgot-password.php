...
<?php
  ...
  include '../config/reset_password.php'; // or require 'config.php';
?>
    <div class="container">
        <div class="logo"></div>
        ...
        <form action="../config/reset_password.php" method="post">
            ...
            <div class="password-container">
                ...
                <i class="fas fa-eye toggle-password" id="toggleNewPass" title="Show Password"></i>
            </div>

            <label for="confirm_pass">Confirm Password:</label>
            <div class="password-container">
                <input type="password" id="confirm_pass" name="confirm_pass" required>
                <i class="fas fa-eye toggle-password" id="toggleConfirmPass" title="Show Password"></i>
            </div>

            <button type="submit">Reset Password</button>
        </form>
        <p>Remember your password? <a href="admin-login.php"> Sign in here</a></p>
    </div>
